...
try:
    ...
    print("⚠️ Advertencia: No se encontró 'logo.png'.")
    logo_icon = None
...
# ---- Área central con 4 grandes botones táctiles ----
...
def abrir_wave_visualization():
    print("📊 Opening wave visualization...")
    try:
...
def abrir_neurofeedback():
    ...
    try:
        subprocess.Popen(["python", "neurofeedback.py"])
    except Exception as e:
        print(f"Error: {e}")
...
botones_data = [
    ("Wave\nVisualization", "🌊", abrir_wave_visualization, "#8A94B8", "1"),
    ("Game 1", "🎮", abrir_game1, "#9FA8C4", "2"),
    ("Neurofeedback", "⚡", abrir_neurofeedback, "#A8B5D1", "3"),
    ("Report", "📊", abrir_report, "#B4BDDA", "4"),
]
